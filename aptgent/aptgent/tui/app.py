...
from aptgent.tui.theme_variables import THEME_VARIABLE_DEFAULTS as _THEME_VARIABLE_DEFAULTS
...
QTY_THEME = _build_theme(
    ...
    dark=True,
    variables={
        "button-color-foreground": "#082015",
        "input-selection-background": "#3FB8A033",
        "chat-system-background": "#14271A",
        "chat-system-foreground": "#E4F0E6",
        "chat-system-accent": "#3FB8A0",
        "chat-stream-background": "#16291C",
        "chat-stream-foreground": "#ECF6EE",
        "chat-stream-accent": "#5BD1B4",
        "chat-tool-background": "#101D15",
        "chat-tool-foreground": "#AFC9B8",
        "chat-tool-accent": "#4F7A63",
        "chat-user-background": "#1B3320",
        "chat-user-foreground": "#EEF7E9",
        "chat-user-accent": "#6FB544",
        "chat-thinking-background": "#101D15",
        "chat-thinking-foreground": "#B5CBBC",
        "chat-thinking-accent": "#E8743B",
        "chat-thinking-frame-muted": "#6A8B78",
        "chat-thinking-frame-soft": "#93B3A0",
        "chat-thinking-frame-bright": "#CDE6D6",
        "chat-thinking-frame-hot": "#E8743B",
        "chat-activity-background": "#15271B",
        "chat-activity-foreground": "#D6E8D9",
        "chat-activity-accent": "#E8743B",
        "chat-activity-label": "#A9C9B3",
        "chat-activity-frame-muted": "#5E7A66",
        "chat-activity-frame-soft": "#87A88F",
        "chat-activity-frame-bright": "#D2E6D6",
        "chat-activity-frame-hot": "#E8743B",
        "chat-activity-final-icon": "#E8743B",
        "chat-progress-background": "#0D1B12",
        "chat-progress-foreground": "#9CBFA6",
        "chat-progress-border": "#25563B",
        "chat-status-background": "#101E15",
        "chat-status-foreground": "#8BAE96",
        "chat-status-border": "#1A3A28",
        "chat-divider-color": "#5BD1B4",
        "chat-markdown-code": "#8BE0C9",
    },
)

ZYX_THEME = _build_theme(
    name="zyx",
    primary="#5E7079",
    secondary="#D6DBDD",
    warning="#B07A3C",
    ...
    variables={
        "button-color-foreground": "#FFFFFF",
        "input-selection-background": "#5E707933",
        "chat-system-background": "#FAFBFB",
        "chat-system-foreground": "#272B2D",
        "chat-system-accent": "#5E7079",
        "chat-stream-background": "#F2F4F4",
        "chat-stream-foreground": "#2C3133",
        "chat-stream-accent": "#5E7079",
        "chat-tool-background": "#E9ECEC",
        "chat-tool-foreground": "#555E62",
        "chat-tool-accent": "#8A9398",
        "chat-user-background": "#EFEAE4",
        "chat-user-foreground": "#2E2A26",
        "chat-user-accent": "#8C6239",
        "chat-thinking-background": "#EEF0F0",
        "chat-thinking-foreground": "#525B5F",
        "chat-thinking-accent": "#B07A3C",
        "chat-thinking-frame-muted": "#8C9499",
        "chat-thinking-frame-soft": "#AAB1B5",
        "chat-thinking-frame-bright": "#D5DADC",
        "chat-thinking-frame-hot": "#B07A3C",
        "chat-activity-background": "#F0ECE5",
        "chat-activity-foreground": "#574B3B",
        "chat-activity-accent": "#B07A3C",
        "chat-activity-label": "#8A7860",
        "chat-activity-frame-muted": "#B0A48F",
        "chat-activity-frame-soft": "#CDC2AC",
        "chat-activity-frame-bright": "#E6DCC8",
        "chat-activity-frame-hot": "#B07A3C",
        "chat-activity-final-icon": "#B07A3C",
        "chat-progress-background": "#E6E9E9",
        "chat-progress-foreground": "#4C565A",
        "chat-progress-border": "#B7BFC2",
        "chat-status-background": "#EEF0F0",
        "chat-status-foreground": "#5C666A",
        "chat-status-border": "#C8CFD1",
        "chat-divider-color": "#5E7079",
        "chat-markdown-code": "#8C6239",
    },
)

QJX_THEME = _build_theme(
    name="qjx",
    primary="#E8822E",
    secondary="#3A2A20",
    warning="#F6B33D",
    ...
    dark=True,
    variables={
        "button-color-foreground": "#1B130C",
        "input-selection-background": "#E8822E33",
        "chat-system-background": "#211710",
        "chat-system-foreground": "#F2E2D2",
        "chat-system-accent": "#E8822E",
        "chat-stream-background": "#251A12",
        "chat-stream-foreground": "#F8E9D8",
        "chat-stream-accent": "#F0A24B",
        "chat-tool-background": "#15100B",
        "chat-tool-foreground": "#C7BBA9",
        "chat-tool-accent": "#5B9AA0",
        "chat-user-background": "#3A2415",
        "chat-user-foreground": "#FBEEDD",
        "chat-user-accent": "#F6B33D",
        "chat-thinking-background": "#17110B",
        "chat-thinking-foreground": "#CBBBA8",
        "chat-thinking-accent": "#F0A24B",
        "chat-thinking-frame-muted": "#877262",
        "chat-thinking-frame-soft": "#B0967E",
        "chat-thinking-frame-bright": "#DAC7B2",
        "chat-thinking-frame-hot": "#F6B33D",
        "chat-activity-background": "#2A1C12",
        "chat-activity-foreground": "#F1DCC4",
        "chat-activity-accent": "#F6B33D",
        "chat-activity-label": "#D8BE9D",
        "chat-activity-frame-muted": "#8D7256",
        "chat-activity-frame-soft": "#B39773",
        "chat-activity-frame-bright": "#E2CDAE",
        "chat-activity-frame-hot": "#F6B33D",
        "chat-activity-final-icon": "#F6B33D",
        "chat-progress-background": "#1A130D",
        "chat-progress-foreground": "#C2A88F",
        "chat-progress-border": "#5A3A22",
        "chat-status-background": "#1F150D",
        "chat-status-foreground": "#B0967E",
        "chat-status-border": "#3B2A1B",
        "chat-divider-color": "#F0A24B",
        "chat-markdown-code": "#6FBEC4",
    },
)
...
class AptgentApp(App):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.register_theme(QTY_THEME)
        self.register_theme(ZYX_THEME)
        self.register_theme(QJX_THEME)
