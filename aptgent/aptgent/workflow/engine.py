...
TRANSITIONS: dict[Step, list[Step]] = {
    ...
    Step.PRIMARY_SCORING: [Step.DOCKING_SELECTION],
    Step.DOCKING_SELECTION: [Step.DOCKING_RUN, Step.SPECIFICITY_FILTER],
    Step.DOCKING_RUN: [Step.SPECIFICITY_FILTER],
    Step.SPECIFICITY_FILTER: [Step.SPATIAL_RANK],
